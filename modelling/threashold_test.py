...
def image_position(image,x1,x2,z1,z2, LB):
    ...
    for i in range(1, diffzml-1):
        for j in range(1, diffxml-1):
            if array[i,j] >= LB:
                density[i,j] = array[i,j]
            else:
                density[i,j] = 0
...
for m in range(0, length):
    ...
    imaged_centred1 = centre_image(addition1,values1[0],values1[1],values1[2],values1[3],positionx1,positionz1, 0, input_size, 0)
    ...
    output1 = r"D:\Documents\modeling\Bengin\threashold_tests\%s_base.png"%(ren[m].replace('.dcm',''))
    output2 = r"D:\Documents\modeling\Bengin\threashold_tests\%s_lvl1.png"%(ren[m].replace('.dcm',''))
    output3 = r"D:\Documents\modeling\Bengin\threashold_tests\%s_lvl2.png"%(ren[m].replace('.dcm',''))
    output4 = r"D:\Documents\modeling\Bengin\threashold_tests\%s_lvl3.png"%(ren[m].replace('.dcm',''))
    output5 = r"D:\Documents\modeling\Bengin\threashold_tests\%s_centre.png"%(ren[m].replace('.dcm',''))
    plt.imsave(output1,base_sample1[2])
    plt.imsave(output2, lvl1_sample1[2])
    plt.imsave(output3, lvl2_sample1[2])
    plt.imsave(output4, lvl3_sample1[2])
    plt.imsave(output5, imaged_centred1[2])
